...
To level up the connection between Lambda and Lex, I customise your chatbot's text response when a user asks for their bank balance.

Now, the message my users see when they ask for their bank balance is a customised message of a top secret account.

![Image](http://learn.nextwork.org/content_rose_beautiful_white_sapote/uploads/aws-ai-lex3_38b5f5691)
